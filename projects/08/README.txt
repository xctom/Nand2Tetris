...
About Sys.init
1.According to the requirement of Project08, there will be a bootstrap code at the begin of the output asm file. So if there is no Sys.init function in vm files, there may be mistakes when running the asm code.